...
export function DhruvaDetailsPage() {
    return (
                ...
                <div className="relative z-30 mx-auto grid h-screen max-w-[1600px] grid-cols-[40%_60%] items-center px-10 md:px-[60px]">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row">
                            <button
                                onClick={() => document.getElementById('dhruva-core-section')?.scrollIntoView({ behavior: 'smooth' })}
                ...
                <div className="mx-auto grid h-full w-full max-w-[1900px] grid-cols-4 gap-10 px-16">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="max-w-sm text-lg leading-relaxed text-gray-600">
                            The symmetric architecture minimizes drag while ensuring
                            balanced thrust distribution and ease of fabrication.
                        </p>
                ...
                <div className="relative z-10 grid min-h-screen grid-cols-[50%_60%] items-center px-20">
                    ...
                    <div>
                        ...
                        <div className="relative max-w-[600px] text-white">
                            ...
                            {[
                                { left: { label: 'Length',        value: '480 mm'           }, right: { label: 'Thrusters', value: '8 (4H + 4V)' } },
                                { left: { label: 'Width',         value: '200 mm'           }, right: { label: 'Endurance', value: '4+ Hours'     } },
                                { left: { label: 'Height',        value: '210 mm'           }, right: { label: 'Payload',   value: '1.5 kg'       } },
                                { left: { label: 'Pressure Hull', value: '110 mm Acrylic Tube' }, right: { label: 'Max Depth', value: '300 m'     } },
                            ].map((row, i) => (
